...
| 버전  | 날짜       | 변경 내용                                                                                    |
| ----- | ---------- | ------------------------------------------------------------------------------------------------ |
| 1.0.0 | 2024-12-20 | 데이터베이스 정의서 초안 (PostgreSQL + MongoDB)                                              |
| 1.1.0 | 2025-12-28 | 결제 시스템 TODO 상세화<br>- PG사 선정 후 추가 예정으로 명시<br>- 기본 테이블 구조 가이드라인 제공 |
| 1.2.0 | 2025-12-28 | 화면 정의서 정합성 검증 결과 반영<br>- oauth_accounts 테이블 추가 (H002 로그인)<br>- user_settings 테이블 추가 (H010 설정)<br>- voting_power 테이블 추가 (H004 투표)<br>- ticket_reservations에 seat_info, payment_method 필드 추가<br>- users.username 설명 "닉네임"으로 명확화<br>- ERD 업데이트 |
