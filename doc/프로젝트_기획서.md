...
-   **라이브 스트리밍**: YouTube Live 임베드 지원 (MVP). Weverse Live는 Next 단계에서 검토
...
| 1.1.0 | 2025-12-28 | 라이브 스트리밍 아키텍처 확정<br>- YouTube Live 임베드(MVP) + Weverse Live는 Next 검토로 정리<br>- AWS Media Services 기술 스택에서 제거 | 정지원 |
