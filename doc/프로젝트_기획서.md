...
-   **라이브 스트리밍**: YouTube Live, V LIVE 등 외부 스트리밍 URL 임베드 지원 (자체 스트리밍 서버 운영 없음)
...
### 6.1 뉴스 자동 요약
-   크롤링된 뉴스 기사를 OpenAI API / 한국어 NLP 모델로 요약
...
| 버전  | 날짜       | 변경 내용                                                                                    |
| ----- | ---------- | ------------------------------------------------------------------------------------------------ |
| 1.0.0 | 2024-12-27 | 프로젝트 기획서 초안                                                                          |
| 1.1.0 | 2025-12-28 | 라이브 스트리밍 아키텍처 확정<br>- YouTube/V LIVE 외부 임베드 방식으로 최종 결정<br>- AWS Media Services 기술 스택에서 제거 |
