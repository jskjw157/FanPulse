    ...
    fun getEvents() = intent {
        ...
        try {
            coroutineScope {
                ...
                val getLiveEvents = liveEventsDeferred.await()

                Log.d("LiveViewModel", "API 호출 완료 - Stream:${getStreamEvents.isSuccessful}, Scheduled:${getScheduledEvents.isSuccessful}, Live:${getLiveEvents.isSuccessful}")
