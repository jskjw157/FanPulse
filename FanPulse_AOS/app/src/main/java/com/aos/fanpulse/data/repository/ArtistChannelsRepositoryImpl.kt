...
class ArtistChannelsRepositoryImpl @Inject constructor(
     ...
     */
    override suspend fun getArtistChannels(): Response<ArtistChannelListResponse> {
     ...
     */
    override suspend fun discoverChannels(): Response<ChannelDiscoverResponse> {
     ...
     */
    override suspend fun getArtistChannelDetail(
        channelId: String
    ): Response<ArtistChannel> {
     ...
     */
    override suspend fun deleteArtistChannel(
        id: String
    ): Response<Unit> {
     ...
     */
    override suspend fun patchArtistChannel(
        id: String,
     ...
     */
    override suspend fun getArtistChannelsByArtistId(
        artistId: String
