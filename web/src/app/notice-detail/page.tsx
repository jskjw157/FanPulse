      ...
      <PageWrapper>
        <div className="max-w-3xl mx-auto px-4 py-6">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 space-y-3">
            {prevNotice && (
              <Link
                href={`/notice-detail?id=${prevNotice.id}`}
            ...
            {nextNotice && (
              <Link
                href={`/notice-detail?id=${nextNotice.id}`}
                className="block p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors"
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1">
          ...
          <div className="mt-6">
            <Link
              href="/support"
              className="block w-full bg-gray-100 text-gray-700 text-center py-3 rounded-full font-medium text-sm hover:bg-gray-200 transition-colors"
            >
              목록으로
            </Link>
          </div>
