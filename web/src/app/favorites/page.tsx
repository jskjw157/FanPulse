    ...
    <ProtectedRoute>
      ...
      <PageWrapper>
        <div className="max-w-3xl mx-auto px-4 py-4">
          {/* Stats */}
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-4 mb-4 shadow-md">
          ...
          <div className="flex gap-2 mb-4 overflow-x-auto pb-2 scrollbar-hide">
            <button className="px-4 py-2 bg-purple-600 text-white rounded-full text-sm font-medium whitespace-nowrap shadow-sm">
              전체 ({artists.length})
            </button>
          ...
          {artists.length > 0 ? (
            <div className="space-y-3">
              {artists.map((artist) => (
                <div key={artist.id} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                  <div className="flex gap-3 p-3">
                    <Link href="/artist-detail" className="flex-shrink-0">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <button
                        ...
                        className="w-9 h-9 bg-red-50 text-red-500 rounded-full flex items-center justify-center hover:bg-red-100 transition-colors"
                      >
            ...
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <Link
                href="/"
                className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-full font-medium shadow-md"
              >
                아티스트 둘러보기
              </Link>
            </div>
