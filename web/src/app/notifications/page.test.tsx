...
describe('NotificationsPage', () => {
  ...
  it('renders API notifications without fabricated users, avatars, or links', () => {
    hook.mockReturnValue({ notifications: [row], state: 'success', error: null, retry: vi.fn(), markAllRead: vi.fn(), markingAll: false });
  ...
  it('changes the API unread filter and marks all read', () => {
    ...
    hook.mockReturnValue({ notifications: [row], state: 'success', error: null, retry: vi.fn(), markAllRead, markingAll: false });
    render(<NotificationsPage />);
