    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-pink-50 pb-20 lg:pb-0">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-16">
            ...
            <Link to="/" className="flex items-center">
              <h1 className="text-xl md:text-2xl font-bold text-white lg:bg-gradient-to-r lg:from-purple-600 lg:to-pink-600 lg:bg-clip-text lg:text-transparent" style={{ fontFamily: '"Pacifico", serif' }}>
                FanPulse
              </h1>
            </Link>
            ...
            <nav className="hidden lg:flex items-center gap-1">
              <Link to="/" className="px-4 py-2 rounded-lg bg-purple-50 text-purple-600 font-medium">
                Home
              </Link>
              <Link to="/community" className="px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-50 font-medium">
                Community
              </Link>
              <Link to="/live" className="px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-50 font-medium">
                Live
              </Link>
              <Link to="/voting" className="px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-50 font-medium">
                Voting
              </Link>
              <Link to="/chart" className="px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-50 font-medium">
                Chart
              </Link>
              <Link to="/concert" className="px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-50 font-medium">
                Concert
              </Link>
            </nav>
            ...
            <div className="flex items-center gap-2">
              <Link to="/search" className="w-9 h-9 lg:w-10 lg:h-10 flex items-center justify-center rounded-lg lg:hover:bg-gray-100">
                <i className="ri-search-line text-xl text-white lg:text-gray-700"></i>
              </Link>
              <Link to="/notifications" className="w-9 h-9 lg:w-10 lg:h-10 flex items-center justify-center rounded-lg lg:hover:bg-gray-100 relative">
              ...
              <Link to="/mypage" className="hidden lg:flex w-10 h-10 items-center justify-center rounded-lg hover:bg-gray-100">
      ...
      {isMenuOpen && (
        <>
          ...
          <div className="fixed top-0 right-0 bottom-0 w-72 bg-white z-[70] shadow-2xl">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/live" className="text-sm lg:text-base text-purple-600 font-medium hover:text-purple-700">View All</Link>
            </div>
          ...
          <div className="mt-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/community" className="text-sm lg:text-base text-purple-600 font-medium hover:text-purple-700">더보기</Link>
            </div>
          ...
          <div className="mt-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/chart" className="text-sm lg:text-base text-purple-600 font-medium hover:text-purple-700">전체보기</Link>
            </div>
            <div className="bg-white rounded-2xl p-4 lg:p-6 shadow-sm">
              <div className="space-y-3">
                {chartRankings.map((item, index) => (
                  <Link 
                    key={item.rank} 
                    to={`/artist-detail?artist=${item.artist}`}
          ...
          <div className="mt-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/voting" className="text-sm lg:text-base text-purple-600 font-medium hover:text-purple-700">Vote Now</Link>
            </div>
          ...
          <div className="mt-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/concert" className="text-sm lg:text-base text-purple-600 font-medium hover:text-purple-700">See All</Link>
            </div>
          ...
          <div className="mt-8 mb-6 grid grid-cols-3 gap-4 lg:gap-6">
            <Link to="/ads" className="bg-gradient-to-br from-yellow-400 to-orange-500 rounded-2xl p-4 lg:p-6 text-center shadow-sm hover:shadow-md transition-shadow">
            ...
            <Link to="/membership" className="bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl p-4 lg:p-6 text-center shadow-sm hover:shadow-md transition-shadow">
              <div className="w-10 h-10 lg:w-14 lg:h-14 mx-auto flex items-center justify-center">
            ...
            <Link to="/community" className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl p-4 lg:p-6 text-center shadow-sm hover:shadow-md transition-shadow">
              <div className="w-10 h-10 lg:w-14 lg:h-14 mx-auto flex items-center justify-center">
