    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <header className="fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-50">
        <div className="px-4 py-3 flex items-center justify-between">
          ...
          <h1 className="text-base font-bold text-gray-900">뉴스 상세</h1>
      ...
      <div className="pt-14">
        ...
        <div className="px-4 py-4">
          ...
          <div className="flex items-center gap-3 mt-6 pt-6 border-t border-gray-200">
            <button className="flex-1 bg-gray-100 text-gray-700 py-3 rounded-xl font-medium text-sm flex items-center justify-center gap-2">
        ...
        {/* Related News */}
        <div className="px-4 py-6 bg-gray-50 mt-6">
